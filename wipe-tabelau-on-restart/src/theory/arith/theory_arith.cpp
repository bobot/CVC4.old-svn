...
void TheoryArith::notifyRestart(){
  ...
  static const bool minimalWipe = true;
  ...
  }else{ /** reinitialize all slack variables. */
    while(!d_requiresInitialization.empty()){
      ArithVar slack = d_requiresInitialization.back();
      setupSlackInTableau(slack);
      Assert(!d_requiresInitialization.isMember(slack));
    }
  }
}
