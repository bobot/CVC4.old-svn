 ...
 **
 ** Original code derived from CVC3 search_sat.cpp (Clark Barrett)
 **/

#include "justification_heuristic_exp.h"
...
// JustificationHeuristicExp stuff

void JustificationHeuristicExp::setJustified(TNode n)
{
  d_justified.insert(n);
}

bool JustificationHeuristicExp::checkJustified(TNode n)
{
  return d_justified.find(n) != d_justified.end();
}

SatValue JustificationHeuristicExp::tryGetSatValue(Node n)
{
...
void JustificationHeuristicExp::computeITEs(TNode n, IteList &l)
{
...
const IteList& JustificationHeuristicExp::getITEs(TNode n)
{
...
bool JustificationHeuristicExp::findSplitterRec(TNode node, 
                                             SatValue desiredVal,
