/*********************                                                        */
/*! \file justification_heuristic_exp.h
 ** \verbatim
 ...
 **
 ** \brief Justification heuristic for decision making (experiment ground)
 **
...
#ifndef __CVC4__DECISION__JUSTIFICATION_HEURISTIC_EXP
#define __CVC4__DECISION__JUSTIFICATION_HEURISTIC_EXP
...
class JustificationHeuristicExp : public ITEDecisionStrategy {
...
public:
  JustificationHeuristicExp(CVC4::DecisionEngine* de, context::Context *c):
    ITEDecisionStrategy(de, c),
    d_justified(c),
    d_prvsIndex(c, 0),
    d_helfulness("decision::jhexp::helpfulness", 0),
    d_giveup("decision::jhexp::giveup", 0),
    d_expense("decision::jhexp::expense", 0),
    d_timestat("decision::jhexp::time") {
    StatisticsRegistry::registerStat(&d_helfulness);
    StatisticsRegistry::registerStat(&d_giveup);
    StatisticsRegistry::registerStat(&d_expense);
    StatisticsRegistry::registerStat(&d_timestat);
    Trace("decision") << "Justification heuristic (exp) enabled" << std::endl;
  }
  ~JustificationHeuristicExp() {
  ...
  prop::SatLiteral getNext(bool &stopSearch) {
    Trace("decision") << "JustificationHeuristicExp::getNext()" << std::endl;
  ...
  void addAssertions(const std::vector<Node> &assertions,
    ...
    Trace("decision")
      << "JustificationHeuristicExp::addAssertions()" 
...
};/* class JustificationHeuristicExp */

}/* namespace decision */

}/* namespace CVC4 */

#endif /* __CVC4__DECISION__JUSTIFICATION_HEURISTIC_EXP */
