...
inline DecisionMode stringToDecisionMode(std::string option, std::string optarg, SmtEngine* smt) throw(OptionException) {
  ...
  options::decisionRandomChild.set(false);
  options::decisionLookahead.set(false);
  ...
  if(optarg == "internal") {
  ...
  } else if(optarg == "justification-lookahead") {
    options::decisionLookahead.set(true);
    return DECISION_STRATEGY_JUSTIFICATION;
  } else if(optarg == "justification-rand") {
    options::decisionRandomChild.set(true);
    return DECISION_STRATEGY_JUSTIFICATION;
    ...
    return DECISION_STRATEGY_RELEVANCY;
  } else if(optarg == "justification-rel-rand") {
    options::decisionComputeRelevancy.set(false);
    options::decisionRandomChild.set(true);
    return DECISION_STRATEGY_RELEVANCY;
