 ...
 */
annotatedFormula[CVC4::Node& expr]
@init {
  ...
  | /* A non-built-in function application */
    ...
    // TODO: check arity
    { expr = smtInput->mkNode(CVC4::kind::APPLY,args); }
  ...
  | /* An ite expression */
    ...
    { args.push_back(expr); } 
    RPAREN_TOK
    { expr = smtInput->mkNode(CVC4::kind::ITE, args); }
  ...
  | /* a variable */
    ...
    /* constants */
  | TRUE_TOK          { expr = smtInput->trueNode(); }
  | FALSE_TOK         { expr = smtInput->falseNode(); }
...
annotatedFormulas[std::vector<CVC4::Node>& formulas, CVC4::Node& expr]
