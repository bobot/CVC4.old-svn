...
#ifdef _cvc3__include__vc_h_
#  error CVC3's vc.h header was included before CVC4's cvc3_compat.h header.  Please include cvc3_compat.h rather than vc.h.
#else
...
template <class T>
class ExprMap : public std::hash_map<Expr, T> {
};/* class ExprMap<T> */
