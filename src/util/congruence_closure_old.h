...
#ifndef __CVC4__UTIL__CONGRUENCE_CLOSURE_OLD_H
#define __CVC4__UTIL__CONGRUENCE_CLOSURE_OLD_H
...
class CVC4_DEPRECATED CongruenceClosure;
...
#define CONGRUENCE_OPERATORS_1(kind1) ::CVC4::old::CongruenceOperator<kind1, ::CVC4::old::EndOfCongruenceOpList>
#define CONGRUENCE_OPERATORS_2(kind1, kind2) ::CVC4::old::CongruenceOperator<kind1, CONGRUENCE_OPERATORS_1(kind2)>
#define CONGRUENCE_OPERATORS_3(kind1, kind2, kind3) ::CVC4::old::CongruenceOperator<kind1, CONGRUENCE_OPERATORS_2(kind2, kind3)>
#define CONGRUENCE_OPERATORS_4(kind1, kind2, kind3, kind4) ::CVC4::old::CongruenceOperator<kind1, CONGRUENCE_OPERATORS_3(kind2, kind3, kind4)>
#define CONGRUENCE_OPERATORS_5(kind1, kind2, kind3, kind4, kind5) ::CVC4::old::CongruenceOperator<kind1, CONGRUENCE_OPERATORS_4(kind2, kind3, kind4, kind5)>
...
#endif /* __CVC4__UTIL__CONGRUENCE_CLOSURE_OLD_H */
